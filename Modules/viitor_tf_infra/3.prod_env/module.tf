...
module "east_vnet01" {
  source = "../0.Infra_modules/virtualNetwork"
    rg_name = "viitor-east-prod-rg01"
    vent_name = "viitor-east-prod-vnet01"
    vnet_address_space = ["10.0.0.0/16"]
    vnet_private_subnet01 = "prodprivate-subnet01"
    vnet_private_subnet_address_space = ["10.0.1.0/24"]
    vnet_public_subnet01 = "prodpublic-subnet01"
    vnet_public_subnet_address_space = ["10.0.2.0/24"]
    vnet_db_subnet01 = "prodDB-Subnet01"
    vnet_db_subnet_address_space = ["10.0.3.0/24"]
    tags = local.common_tags
}
